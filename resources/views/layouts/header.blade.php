      ...
      <ul class="nav-menus">
        ...
        <li class="profile-nav onhover-dropdown pe-0 py-0">
          <div class="media profile-media">
            ...
            <img height="40px" width="40px" class="rounded-circle" src="{{ asset('storage/profile_images/placeholder.png') }}" alt="">
            @else
          ...
          <ul class="profile-dropdown onhover-show-div">
            <li><a href="{{route('admin.user-profile')}}"><i data-feather="user"></i><span>Account </span></a></li>
            <li><a href="{{route('admin.change-password')}}"><i data-feather="password"></i><span>Change Password</span></a></li>
