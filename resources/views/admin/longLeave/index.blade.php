                                                ...
                                                <div class="">
                                                    <select name="policy_id" class="form-select" id="validationCustom04" required="">
                                                        ...
                                                        @foreach ($leaveEntitlement as $leaveType)
                                                            <option value="{{ $leaveType->policy->id }}" data-monthly="{{ $leaveType->policy->monthly }}" data-advance-salary="{{ $leaveType->policy->advance_salary }}" data-number-of-days="{{ $leaveType->policy->days }}">
