                                        ...
                                        <tr class="shortLeave_id{{$list->id}}">
                                            ...
                                            <td>
                                                <div class="form-check checkbox checkbox-dark mb-0">
                                                    <input class="form-check-input" name="massDelete[]" id={{"inline-".$list->id}} value="{{ $list->id }}" type="checkbox" data-bs-original-title="" title>
                                            ...
                                            <td>
                                                ...
                                                <ul class="action">
                                                    ...
                                                    @endcan
                                                    @can('short_leave_delete')
                                                    <form action="{{route('admin.'.$url.'.destroy',['short_leave'=>$list->id])}}" method="post">
                                                        @csrf
                                                        @method('DELETE')
