                                                ...
                                                <ul class="action">
                                                    ...
                                                    <div class="modal fade" id="editModal{{ $list->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenter" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <form action="{{ route('admin.'.$url.'.update', ['shortLeave' => $list->id]) }}" method="POST" class="modal-content">
                                                                @csrf
                                                                @method('PUT')
                                                                <div class="modal-header">
                                                    ...
                                                    <form action="{{route('admin.'.$url.'.destroy',['shortLeave'=>$list->id])}}" method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                    ...
                                                    <form action="{{ route('admin.'.$url.'.update', ['shortLeave' => $list->id]) }}" method="post">
                                                        @csrf
                                                        @method('PUT')
