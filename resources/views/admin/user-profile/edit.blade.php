...
<div class="container card">
    <div class="card-body">
        ...
        <form action="{{route("admin.user-profile.update",['user_profile'=>auth()->user()->id])}}" method="POST"  enctype="multipart/form-data" class="needs-validation" novalidate="">
            @csrf
            @method('PUT')
        ...
        <div class="d-flex justify-content-end">
            <div>
                <a href="{{ url('admin/user-profile') }}" class="mx-2"><u>Back</u></a>
        ...
        <ul class="nav nav-tabs border-tab nav-primary" id="top-tab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link active" id="top-profile-tab" data-bs-toggle="tab" href="#top-profile"
                    role="tab" aria-controls="top-profile" aria-selected="true"><i
                        class="icofont icofont-man-in-glasses"></i>Profile</a>
            </li>


            <li class="nav-item">
                <a class="nav-link " id="user-setting-tab" data-bs-toggle="tab" href="#top-user-setting"
                    role="tab" aria-controls="top-user-setting" aria-selected="false">
        ...
        <div class="tab-content" id="top-tabContent">
            ...
            <div class="tab-pane show active fade " id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">

                    @if(!empty($user->profile->image))
                    <div class="row mb-4 d-flex align-items-center">
                        <img id="profile-image" height="140px" width="140px" src="{{ asset('storage/profile_images/'.$user->profile->image?? "") }}" alt="Profile Picture" class="rounded-circle media profile-media profile-image" style="max-width: 150px; max-height: 150px;">
                    ...
                    @else
                    <div class="row mb-4 d-flex align-items-center">
                    <img  id="profile-image" height="140px" width="140px" class="rounded-circle media profile-media profile-image" style="max-width: 150px; max-height: 150px;" src="{{ asset('storage/profile_images/placeholder.png') }}" alt="">                
            ...
            <div class="tab-pane fade" id="top-user-setting" role="tabpanel"  aria-labelledby="user-setting-tab">
                cscsd
            </div>
